...
public class GroupMemberData
{
    ...
    public float m_SpecialPoints;
    public float m_BaseSpecialPoints;
    ...
    public GroupMemberData(float p_Health, float p_BaseHealth, float p_SpecialPoints, float p_BaseSpecialPoints, float p_AttackStat, float p_DefenseStat, float p_SpeedStat)
    {
        ...
        m_SpecialPoints = p_SpecialPoints;
        m_BaseSpecialPoints = p_BaseSpecialPoints;
        m_AttackStat = p_AttackStat;
        m_DefenseStat = p_DefenseStat;
        m_SpeedStat = p_SpeedStat;
    }
}